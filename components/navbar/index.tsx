                  ...
                  {navigationData.map((navItem) => {
                    return (
                      <NavigationMenuItem key={navItem.title}>
                        <NavigationMenuLink
                          href={navItem.href}
                          className={`px-2 lg:px-4 py-2 text-sm font-medium rounded-full text-foreground hover:text-foreground hover:bg-primary outline outline-transparent hover:outline-border hover:shadow-xs transition tracking-normal`}
                        >
                          {navItem.title}
                        </NavigationMenuLink>
                      </NavigationMenuItem>
